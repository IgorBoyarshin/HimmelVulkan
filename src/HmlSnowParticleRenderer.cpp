...
std::unique_ptr<HmlSnowParticleRenderer> HmlSnowParticleRenderer::createSnowRenderer(
    ...
    hmlRenderer->snowTextureResources.push_back(hmlContext->hmlResourceManager->newTextureResource("../models/snow/snowflake1.png", VK_FORMAT_R8G8B8A8_SRGB, VK_FILTER_NEAREST));
    hmlRenderer->snowTextureResources.push_back(hmlContext->hmlResourceManager->newTextureResource("../models/snow/snowflake2.png", VK_FORMAT_R8G8B8A8_SRGB, VK_FILTER_NEAREST));
